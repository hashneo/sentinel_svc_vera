...
module.exports.setLightColor = (req, res) => {
    ...
    global.vera.setColor(id, 'urn:upnp-org:serviceId:RGBController1', {r,g,b,w} )
        .then( (status) => {
...
module.exports.runAnimation = (req, res) => {
    ...
    global.vera.startAnimation(id, 'urn:upnp-org:serviceId:RGBController1', program )
        .then( (status) => {
            res.json( { data: { status: status }, result : 'ok' } );
        })
        .catch( (err) => {
...
module.exports.stopAnimation = (req, res) => {
    ...
    global.vera.stopAnimation(id, 'urn:upnp-org:serviceId:RGBController1' )
        .then( (status) => {
            res.json( { data: { status: status }, result : 'ok' } );
        })
        .catch( (err) => {
